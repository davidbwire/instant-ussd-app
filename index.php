...
// require statements below not needed if using a framework
require_once './vendor/autoload.php';
require './UssdEventListener.php';
...
// the code below should ideally be placed in UssdController::ussdAction method
